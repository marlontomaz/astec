...
## Added
- Adicionando relatório de clientes em xls. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)

## [4.10.0] - 2020-07-01

## Added
- Adicionando suporte a HMVC. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)

## Fixed
- Corrigindo erro na listagem quando arquivo não encontrado. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
...
## Changed
- Melhoria em mensagem de erro pasta faltante system. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
...
### Fixed
- Corrigido email de cliente no lugar de vendedor. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
- Corrigido problema na tela de listagem de OS com garantia não numérica. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)

## [4.1.0] - 2020-03-04

### Fixed
- Corrigido layout e links de anexos de OS. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
- Corrigido problema no layout de etiquetas. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
- Corrigido layout e problema ao salvar pagamento. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)

## Changed
- Anexos de OS estruturados dentro de pastas MM-AAAA/OS-#ID. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
...
### Added
- Adicionado opções de configuração do sistema. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
...
### Fixed
- Corrigido arquivo de configurações. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
...
### Changed
- Atualização da versão do Codeigniter para 3.1.11. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
- Refatoramento de controllers para diminuir repetição de código. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
- Simplificado exibição de mensagem de acesso expirado. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
- Remoção de data e hora no menu superior. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
...
### Changed
- Refatoramento de listagens de cadastros. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
...
- Corrigido problema de return-path ao utilizar SMTP. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
- Corrigido erro no link de WhatsApp ao não ter cadastro de emitente. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
...
### Added
- Adicionado anotações na OS. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
...
- Corrigido arquivo de update de data de expiração com data futura. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)

## [3.8.0] - 2019-07-25

### Added
- Adicionada pesquisa por múltiplos status em OS. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
- Ao adicionar OS e Vendas usuário logado preenchido por padrão como responsável. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
...
### Added
- Adicionada funcionalidade de envio de OS por email. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)

## [3.6.0] - 2019-06-29

### Added
- Adicionada verificação de permissão para exibição de estatísticas no painel. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
- Adicionada possibilidade de alteração de preços de produtos e serviços em OS. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
- Adicionada possibilidade de adicionar quantidade de serviços em OS. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)
- Adicionada possibilidade de alterar preços de produtos em Vendas. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)

### Changed
- Modificados alguns elementos de estilização. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)

## [3.5.3] - 2019-05-18

### Fixed
- Corrigido remoção de garantias ao editar OS. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20) e [@willph](https://github.com/willph)
...
### Fixed
- Corrigido pesquisa de termos de garantia. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20).
- Corrigido erro no cadastro de garantias ao buscar nome do usuário logado. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20).
...
### Fixed
- Removendo obrigatoriedade do campo de garantias na tabela de OS para evitar erro ao não preencher no cadastro. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20).

### Changed
- Alterado insert de usuário com permissão para o módulo de auditoria no arquivo sql. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20)

## [3.5.0] - 2019-05-12

### Added
- Adicionado modulo de auditoria para monitoramento de atividades no sistema. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20).
...
## [3.1.16] - 2019-01-14
### Added
- Adicionado e-mail do cliente na impressão da OS. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20).

### Fixed
- Corrigido alteração de senha na tela minha conta [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20).
- Corrigido link no formulário de adicionar arquivo. [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20).

## [3.1.15] - 2018-11-24
### Fixed
- Corrigido campo descrição na impressão e visualização de OS [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20).

## [3.1.14] - 2018-11-13
### Added
- Modelo de impressão de OS otimizando espaços [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20).
...
- Arquivo de changelog [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20).


## [3.1.12] - 2018-08-14
### Added
- Valor total no relatório de OS [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20).
...
### Fixed
- Correção de erro ao gerar relatório sem emitente estar configurado [@RennercoatingsSilva20](https://github.com/@RennercoatingsSilva20).
